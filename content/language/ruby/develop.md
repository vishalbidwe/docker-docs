---
title: Use containers for Ruby development
keywords: Ruby, local, development
description: Learn how to develop your Ruby application locally.
---

## Prerequisites

Complete [Containerize a Ruby application](containerize.md).
...
1. Change to a directory where you want to clone the repository and run the following command.
   ...
   ```console
   $ git clone https://github.com/docker/Ruby-docker-dev
   ```
...
You should now have the following contents in your `Ruby-docker-dev`
directory.
...
Open `Ruby-docker-dev/app.py` in an IDE or text editor and update the `Hello, Docker!` string by adding a few more exclamation marks.
